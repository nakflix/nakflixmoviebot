class script(object):
    START_TXT = """ʜᴇʏ {}
<b>ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇs ᴀɴᴅ sᴇʀɪᴇs ғɪʟᴇs ᴜsɪɴɢ ᴛʜɪs ʙᴏᴛ. ᴀᴅᴅ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴏʀ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ..🤓🤪</b>
⚠️ᴍᴏʀᴇ ʜᴇʟᴘ ʜɪᴛ /help
...
- <a href=https://t.me/NAKFLIXTV>[NAKFLIXTV]</a>
...
"""
    ...
    IMDB_TEMPLATE_TXT = """
Title𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}[{year}]</a> 
\nRatings⭐: {rating}/ 10  
Geners: {genres} 
𝖯𝗈𝗐𝖾𝗋𝖾𝖽 b𝗒 @NAKFLIXTV"""
